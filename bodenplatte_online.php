...
$svg = "<svg
  ...
  <g style=\"color:#000000;fill:none;stroke:#000000;stroke-width:0.1;stroke-linecap:butt;stroke-linejoin:miter;stroke-miterlimit:4;stroke-opacity:1;stroke-dasharray:none;stroke-dashoffset:0;marker:none;visibility:visible;display:inline;overflow:visible;enable-background:accumulate\">
    <rect
       rx=\"8.85\"
       ry=\"8.85\"
       y=\"1.287\"
...
if($layer == 3 || $layer == 4 || $test) {
	 $svg .= "<rect y=\"" . (25.287 - (($thickness-0.13)/ 2)) . "\" x=\"8.087\" height=\"" . ($thickness-0.13) . "\" width=\"" . ($width) . "\" />";
}

// Draw hexagonal holes for nuts
if($layer == 1 || $test) {
	$svg .= "<path d=\"M15.33 9.287 l3.12 0 l1.55 2.69 l-1.55 2.69 l-3.12 0  l-1.55 -2.69 Z\" />
...
<div class="Content">
	  <p>Dieser Assistent soll dabei behilflich sein, einen Standfuß für die mit dem Laser-Cutter erstellten Leuchtschilder zu erstellen. Dies kann sehr Zeitaufwändig sein und zu Stoßzeiten den Betrieb aufhalten. Daher bitte wenn möglich dieses Tool verwenden.</p>
<br />	
	...
	<!-- page 1 -->
	<p id="page1">
	1. Teil: Angaben zum Leuchtschild | 2. Teil: Erstellen der Dateien | <b>3. Teil: Download der erstellten Dateien</b><br />

    <br />

    <a href="files/<?php echo $id;?>/Layer1.svg">Bodenplatte Acrylschild Layer1 3mm</a><br />
    <a href="files/<?php echo $id;?>/Layer2.svg">Bodenplatte Acrylschild Layer2 3mm</a><br />
    <a href="files/<?php echo $id;?>/Layer3.svg">Bodenplatte Acrylschild Layer3 8mm</a><br />
    <a href="files/<?php echo $id;?>/Layer4.svg">Bodenplatte Acrylschild Layer4 3mm</a><br />
    <br />
    <br />
    <a href="files/<?php echo $id;?>/Bodenplatte Acrylschild.zip">Download aller erstellten Dateien als Zip-Archiv</a>
	</p>
